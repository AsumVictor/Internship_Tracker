...
const initialApplications: JobApplication[] = [
  {
    ...
    companyCareerWebsite: "https://globalfinance.com/careers",
    ...
    importantNotes: "Need to prepare financial modeling skills",
  },
  {
    id: "2",
    ...
    companyCareerWebsite: "https://investmentbank.com/jobs",
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold">Finance Job Applications</h2>
        <Dialog>
